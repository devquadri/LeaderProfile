  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        scrolled ? "bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-border shadow-sm" : "bg-transparent"
      }`}
    >
      <div className="max-w-3xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#" className="text-sm font-semibold text-foreground tracking-tight hover:text-muted-foreground transition-colors">
          riyaz.blog
        </a>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 mb-8">
      <span className="text-xs font-semibold tracking-widest uppercase text-muted-foreground">{children}</span>
      <div className="flex-1 h-px bg-border" />
    </div>
  );
}

function ExperienceCard({ job }: { job: (typeof resumeData.experience)[number] }) {
...
function AchievementItem({ text }: { text: string }) {
  return (
    <div className="flex gap-3 text-sm text-muted-foreground leading-relaxed">
      <span className="text-foreground font-semibold mt-0.5 shrink-0 text-xs">✦</span>
      <span>{text}</span>
    </div>
  );
}
...
export default function Portfolio() {
  ...
  const { tagline, contact, summary, expertise, certifications, technicalSkills, achievements, experience, education, languages } =
    resumeData;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="about" className="max-w-3xl mx-auto px-6 pt-32 pb-20">
        <div className="flex items-start justify-between gap-6">
          <div className="flex-1 min-w-0">
            <div className="mb-2">
              <span className="text-xs font-semibold tracking-widest uppercase text-muted-foreground">Technical Support Leader</span>
            </div>
          ...
          <div className="shrink-0 mt-1">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden border-2 border-border bg-muted shadow-sm">
              ...
              >
                ...
                <span className="text-[10px] font-medium text-center px-2 leading-tight">Add photo</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Experience */}
      <section id="experience" className="max-w-3xl mx-auto px-6 py-12 border-t border-border">
      ...
      {/* Skills */}
      <section id="skills" className="max-w-3xl mx-auto px-6 py-12 border-t border-border">
        <SectionLabel>Skills & Expertise</SectionLabel>
        <div className="space-y-8">
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Areas of Expertise</h3>
          ...
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Technical Skills</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Certifications</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">Languages</h3>
            <div className="flex flex-wrap gap-4">
              {languages.map((l) => (
                <div key={l.language} className="flex items-center gap-2 text-sm text-muted-foreground">
      ...
      {/* Contact */}
      <section id="contact" className="max-w-3xl mx-auto px-6 py-12 border-t border-border">
